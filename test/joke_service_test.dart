...
import 'package:StepsInsider/pincus-work-app/lib/features/jokes/data/joke_service.dart';
...
class _FakeClient extends http.BaseClient {
  ...
  Future<http.StreamedResponse> send(http.BaseRequest request) {
    ...
    return Future.value(http.StreamedResponse(stream, response.statusCode, headers: response.headers));
  }
}

void main() {
  test('fetchRandomJoke returns joke map', () async {
    final payload = jsonEncode({'id': 1, 'type': 'general', 'setup': 'Setup', 'punchline': 'Punch'});

  ...
  void _addPhoto() {
    ...
    setState(() => _photos.add(
          SitePhoto(
            ...
            // TODO: Platzhalter – durch echten Kamera-/Upload-Flow ersetzen.
          ...
          child: Column(
            children: [
              ...
              FilledButton.icon(
                ...
                label: const Text('Foto erfassen'),
              ),
              const SizedBox(height: 16),
              Expanded(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            child: ListTile(
                              ...
                              subtitle: Text(
                                'Von ${photo.employeeName} um '
                                '${TimeOfDay.fromDateTime(photo.timestamp).format(context)} Uhr',
                              ),
